...
ast_node* new_local_var_declaration_node(int node_type, ast_node* modifier_static, ast_node *modifier_const ,ast_node* var_type, ast_node* identifier, ast_node* initialization);
