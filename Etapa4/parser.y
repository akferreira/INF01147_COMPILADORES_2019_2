...
function_declaration: TK_PR_STATIC primitive_type TK_IDENTIFICADOR enter_scope'('function_parameters_list')' function_command_block exit_scope{$$ = new_static_function_declaration_node('M',$2,$<valor_lexico>3,$6,$8);};
function_declaration: primitive_type TK_IDENTIFICADOR enter_scope '('function_parameters_list')' function_command_block exit_scope{$$ = new_nonstatic_function_declaration_node('M',$1,$<valor_lexico>2,$5,$7);};




function_command_block: '{'command_list'}' {$$ = new_command_block_node('{',$2);};
...
modifiers:
	TK_PR_STATIC TK_PR_CONST { $$ = modifier(1,1);}
...
local_var_declaration:  modifiers primitive_type TK_IDENTIFICADOR local_var_initialization {$$ = new_local_var_declaration_node('<',$1,$2,$<valor_lexico>3,$4 ) ;};

local_var_declaration: primitive_type TK_IDENTIFICADOR local_var_initialization no_modifier{$$ = new_local_var_declaration_node('<', $4 ,$1,$<valor_lexico>2,$3 ) ;};
local_var_declaration: primitive_type TK_IDENTIFICADOR null_node no_modifier{$$ = new_local_var_declaration_node('<', $4 ,$1,$<valor_lexico>2,$3) ;};
...
expression:  
	TK_IDENTIFICADOR{ $$ = new_leaf_node('I',$<valor_lexico>1);}
	|TK_LIT_INT{ $$ = new_leaf_node('d',$<valor_lexico>1);}
	|TK_LIT_FLOAT{ $$ = new_leaf_node('f',$<valor_lexico>1);}
	|TK_LIT_CHAR{ $$ = new_leaf_node('c',$<valor_lexico>1);}
	|TK_LIT_STRING{ $$ = new_leaf_node('s',$<valor_lexico>1);}
